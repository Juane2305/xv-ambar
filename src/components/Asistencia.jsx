      ...
      {linkAsistencia && linkAsistencia.trim() !== "" && (
        <div className={`pb-20 pt-10 ${clase}`}>
          ...
          <div className="h-full flex flex-col justify-center items-center space-y-2">
            <h2
              className={`text-4xl font-light text-center ${claseTitle} px-3`}
              data-aos="fade-up"
            >
            ...
            >
              <button
                className={`py-4 px-6 mt-5 transform transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-lg ${claseButton}`}
              >
